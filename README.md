...
По умолчанию установлена интерпретация для семейства устройств ГКВ-1 (в него входят ГКВ-1 ОЕМ, ГКВ-1, ГКВ-2 и ГКВ-3). Задано это с помощью #define DEVICE_FAMILY_IS_GKV_1. Если у вас другое устройство, данное объявление необходимо заменить на одно из представленных в списке.
